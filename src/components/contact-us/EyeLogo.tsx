...
const EyeLogo = () => (
  <div className="relative w-10 h-10 flex items-center justify-center flex-shrink-0">
    <div className="absolute inset-0 rounded-full bg-gradient-to-br from-blue-200 via-cyan-200 to-blue-300 animate-pulse"></div>
    ...
    <div className="absolute inset-4 rounded-full bg-gradient-to-br from-blue-100 to-cyan-200"></div>
  </div>
);
