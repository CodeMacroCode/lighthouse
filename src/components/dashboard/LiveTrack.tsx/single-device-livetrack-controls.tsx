...
import { MapPinned, Radius, Satellite, Share2 } from "lucide-react";
    ...
    return (
      <div className="absolute top-4 right-4 z-[1000] flex flex-col gap-2">
        ...
        >
          <RefreshCcw
            size={20}
            className={`text-gray-700 transition-transform ${isRefreshing ? "animate-spin" : ""
              }`}
          />
        </button>
        ...
        <button
          ...
          className={`p-3 rounded-lg shadow-lg transition-all duration-200 cursor-pointer ${isSatelliteView
        ...
        <button
          ...
          className={`p-3 rounded-lg shadow-lg transition-all duration-200 cursor-pointer ${showTraffic
        ...
        <button
          ...
          className={`p-3 rounded-lg shadow-lg transition-all duration-200 relative cursor-pointer ${showGeofences
        ...
        <button
          ...
          className={`p-3 rounded-lg shadow-lg transition-all duration-200 cursor-pointer ${isDrawingGeofence
        ...
        <button
          ...
          className="p-3 rounded-lg shadow-lg transition-all duration-200 cursor-pointer bg-white text-gray-700 hover:bg-gray-100"
